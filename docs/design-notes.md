...
Prose-form design rationale for Eddy. Decisions that proved load-bearing across surfaces have been lifted into `docs/adr/`; the product spec lives in `docs/brief.md`. This file is the thinking trail behind specific design calls — currently Phase 2 feed/timeline UX. Entries can be promoted to ADRs later if they earn it.
